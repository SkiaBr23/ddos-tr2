#coding: utf-8
'''
    Cliente em python para simular RST/FIN Flood 

    Fontes: http://www.binarytides.com/raw-socket-programming-in-python-linux/
'''
import socket, sys
import argparse
...
def montaPacote(seqnumber,source_ip, dest_ip, source_port, dest_port, window_size, id, send_rst, send_fin):
    ...
    # Flags de controle
    fin = send_fin # Aqui ativamos a flag do FIN
    syn = 0  
    rst = send_rst # Aqui ativamos a flag do RST
    psh = 0
    ack = 0
    urg = 0
    ...
    # Pacote final sao os dois headers, pois pacotes RST e FIN nao possuem campo de dados
...
packet = montaPacote(0,args.source_ip, args.dest_ip, args.source_port, randint(1800,65533), args.window_size, args.id, send_rst, send_fin)
